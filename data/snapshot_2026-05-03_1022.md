...
## Macro Prices (IG)
Nasdaq 100: `27664.20` -51.70 (-0.19%)
S&P 500: `7219.61` -10.28 (-0.14%)
Gold: `4614.31`
WTI Crude: `100.45` +0.70 (+0.70%)
Brent Crude: `108.25` +0.85 (+0.79%)
EUR/USD: `1.1721` -0.5000
USD/JPY: `1.5702` -0.0003 (-0.02%)

## US Yields (FRED)
**US 2Y**: 3.88% (-4bps) [FRED 2026-04-30]
**US 10Y**: 4.40% (-2bps) [FRED 2026-04-30]
**US 30Y**: 4.98% (+0bps) [FRED 2026-04-30]

## Equities
COIN: `$191.25` (+3.33, +1.8%)
    Vol: `6.7M` | 7d avg `8.7M` (-23%) | 30d avg `10.6M` (-37%)
MSTR: `$177.17` (+11.62, +7.0%)
    Vol: `21.5M` | 7d avg `17.2M` (+25%) | 30d avg `19.1M` (+13%)
GLXY: `$28.11` (+0.29, +1.1%)
    Vol: `8.0M` | 7d avg `5.8M` (+38%) | 30d avg `5.9M` (+36%)
DFDV: `$4.55` (+0.25, +5.8%)
    Vol: `508K` | 7d avg `555K` (-9%) | 30d avg `948K` (-46%)
IBM: `$232.20` (+0.85, +0.4%)
    Vol: `3.6M` | 7d avg `10.0M` (-64%) | 30d avg `6.0M` (-40%)
MARA: `$11.46` (-0.53, -4.4%)
    Vol: `51.0M` | 7d avg `46.1M` (+11%) | 30d avg `47.0M` (+9%)
JPM: `$312.47` (-0.73, -0.2%)
    Vol: `6.1M` | 7d avg `7.1M` (-14%) | 30d avg `9.4M` (-35%)
MS: `$190.17` (-0.23, -0.1%)
    Vol: `4.7M` | 7d avg `4.6M` (+4%) | 30d avg `6.4M` (-26%)
EQNR: `$39.71` (-1.11, -2.7%)
    Vol: `3.5M` | 7d avg `3.8M` (-9%) | 30d avg `8.0M` (-57%)
FSLR: `$211.71` (+10.61, +5.3%)
    Vol: `5.1M` | 7d avg `2.0M` (+148%) | 30d avg `2.0M` (+152%)
SHEL: `$88.98` (-1.47, -1.6%)
